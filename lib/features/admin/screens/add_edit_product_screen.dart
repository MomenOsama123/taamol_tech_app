      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                  ...
                  Stack(
                    children: [
                      CircleAvatar(
                        ...
                        child: const Icon(Icons.person, size: 50, color: AppColors.deepPurple),
                      ),
                      if (_isAdmin)
                        Positioned(
                          bottom: 0,
                  ...
                  if (user != null) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 11, color: Colors.grey.shade700, fontFamily: 'Tajawal'),
                      ),
                    ),
                  ],
                ],
            ...
            // 2. أدوات الإدارة (تظهر للأدمن فقط وفتحه لشاشة AddEditProductScreen)[cite: 1, 2, 4]
            if (_isAdmin) ...[
              Align(
                alignment: isArabic ? Alignment.centerRight : Alignment.centerLeft,
                child: Text(
                  isArabic ? 'أدوات الإدارة (Admin Panel)' : 'Admin Tools',
                  style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey, fontFamily: 'Tajawal'),
                ),
              ),
              const SizedBox(height: 8),
              Container(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    // 🌟 الربط المباشر مع شاشة إضافة المنتجات للأدمن[cite: 1, 2, 4]
                    Navigator.push(
                      context,
            ...
            Container(
              ...
              child: ListTile(
                leading: const Icon(Icons.settings_outlined, color: AppColors.primaryCyan),
                title: Text(

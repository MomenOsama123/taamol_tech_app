...
class _ProfileScreenState extends State<ProfileScreen> {
  // بيانات ثابتة للمستخدم في التطبيق، بدون أي تعديل من داخل الشاشة
  final String userName = "أحمد المحمدي";
  final String userId = "TK-89420";
  final String userRole = "Admin";
  final String userEmail = "ahmed@tkamol.com";
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Text(
                        isArabic
                            ? 'الحساب الحالي: $userRole'
                            : 'Current account: $userRole',
                        style: const TextStyle(
                          fontSize: 11,
